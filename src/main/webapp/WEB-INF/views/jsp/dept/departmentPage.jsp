                    ...
                    <tbody>
                        <c:forEach items="${pageInfo.list}" var="dept">
                            <tr>
                                ...
                                <td>
                                    <a href="#" role="button" id="btn_deptupdate" class="btn btn-primary dept_edit_btn" data-toggle="modal" data-target=".dept-update-modal"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/>编辑</a>
                ...
                <div class="panel-body">
                    ...
                    <nav aria-label="Page navigation" class="pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="getDeptList?pageNo=${pageInfo.pages}">尾页</a></li>
                        </ul>
                    </nav>
                </div>
            ...
            $.ajax({
                ...
                success:function (result) {
                    if (result.code == 100){
                        ...
                        alert(result.extend.del_dept_error);
                    }
                }
            });
        }
