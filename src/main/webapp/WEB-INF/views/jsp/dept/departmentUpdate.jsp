...
<script type="text/javascript">
	$(document).on("click","#btn_deptupdate",function () {
    ...
    var rewtime = $(this).parent().parent().find("td:eq(2)").text();
	   ...
	   $("#update_deptName").val(money);
	   $("#update_deptLeader").val(rewtime);
   		
   		$(".dept_update_btn").attr("deptId",deptid);
   	});
...
<script type="text/javascript">
    ...
    $(".dept_update_btn").click(function () {
    	 var edit_deptId = $(this).attr("deptId");
